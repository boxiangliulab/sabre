...
python main.py --bam_path ./data/possorted_genome_bam.bam --vcf_path ./data/NA12878.vcf.gz --barcode_path ./data/barcodes.tsv --sample_name NA12878 --restrict_chr chr$i  --verbose --as_quality 0.01 --shortest_path >> output.txt
done
...
python main.py --bam_path ./data/possorted_genome_bam.bam --vcf_path ./data/NA12878.vcf.gz --barcode_path ./data/barcodes.tsv --sample_name NA12878 --restrict_chr chrX  --verbose --as_quality 0.01 --shortest_path >> output.txt
